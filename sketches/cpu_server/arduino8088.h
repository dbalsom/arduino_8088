...
const char* const MACHINE_STATE_STRINGS[] = {
  "Reset",
  "JumpVector",
  "Load",
  "LoadDone",
...
const char *const BUS_STATE_STRINGS[] = {
  "IRQA",
  "IOR ",
  "IOW ",
  "HALT",
...
const char *const CYCLE_STRINGS[] = {
  "t1", "t2", "t3", "t4", "tw"
};

const char *const SEGMENT_STRINGS[] = {
  "ES", "SS", "CS", "DS"
};
...
extern unsigned long CYCLE_NUM_H;
// Low word of cycle count
extern unsigned long CYCLE_NUM;
